CREATE OR REPLACE FORCE VIEW "BEAMLOST_VW" ("PROB_ID", "STATUS", "PROB_TYPE", "CREATED_DATE", "CREATED_BY", "MODIFIED_BY", "MODIFIED_DATE", "SHORT_DESCR", "DESCRIPTION", "AREA", "NUM_SOLS", "NUM_JOBS", "SHOP_MAIN", "SHOP_ALT", "SUBSYSTEM", "CLOSER", "AREAMGR", "BLDGMGR", "ASST_BLDGMGR", "ASSIGNEDTO", "MODIFIER", "BUILDING_NO", "PRIORITY", "FACILITY", "COMPLEVEL", "SUMTIME", "LOST_DATE", "PROGRAM", "PARENT_PROGRAM", "BTIME_ID", "SHIFT", "SHIFT_ORDERING", "CODE_NAME", "ID", "MICRO", "PRIMARY", "UNIT", "URGENCY", "DIV_CODE_ID", "DIV_CODE", "YEAR", "SEPARATE_EVENT_VALUE", "AREA_MGR_REVIEW_DATE", "AREA_MGR_REVIEW_COMMENTS") AS 
  select a.prob_id
      ,decode (a.status_chk,
                0, 'New',
                1, 'In Progress',
