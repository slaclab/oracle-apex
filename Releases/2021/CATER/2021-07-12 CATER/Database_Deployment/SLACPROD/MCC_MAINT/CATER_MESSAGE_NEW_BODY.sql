...
-- Poonam 6/24/2021 - Added new field PA_NUMBER
...
-- Poonam 6/24/2021 - Added new field PA_NUMBER
    message_body_line(pi_prob_id=>l_prob_rec_new.prob_id,pi_prob_type_chk=>l_prob_rec_new.prob_type_chk,pi_label=>'PA Number',			 pi_old=>l_prob_rec_old.pa_number,                                   pi_new=>l_prob_rec_new.pa_number,                                   pi_message_type=>pi_message_type,pi_apex_url_prefix=>pi_apex_url_prefix,pio_html_body=>l_html_message_body,pio_text_body=>l_text_message_body,pio_line_number=>l_line_number);
