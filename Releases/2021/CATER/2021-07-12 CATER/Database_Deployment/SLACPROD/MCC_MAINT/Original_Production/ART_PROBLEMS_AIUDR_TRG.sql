create or replace TRIGGER ART_PROBLEMS_AIUDR_TRG
AFTER INSERT OR UPDATE OR DELETE ON ART_PROBLEMS FOR EACH ROW
declare

    c_proc                       constant varchar2(30)  := 'ART_PROBLEMS_AIUDR_TRG';
    ...
    v_prob_email_id		ART_PROBLEMS_EMAIL.PROB_EMAIL_ID%TYPE;
    v_errmsg                     varchar2(300) := null;
    jn_operation                 varchar2(3);

begin
    v_prob_email_id := art_problems_email_seq.nextval;
