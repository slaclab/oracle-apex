set define off;
--------------------------------------------------------
--  File created - Monday-April-24-2023   
--------------------------------------------------------
--------------------------------------------------------
...
--	l_form_rec_old           SSRL_RSW_FORM%rowtype;
	...
	l_body1		varchar2(500) := '';
	l_body2		varchar2(2000);
	l_var_body	varchar2(1000);
...
--	l_email_to_bldo := 'ssrl-bldo@slac.stanford.edu';
   ...
   l_body2 := ' Last Signed by: '|| l_modified_by ||chr(10)|| '<br><br>' ||
    ...
    apps_util.utl.log_add(p_appl_id => 1, p_trans_id => null, p_message_type_id => 1 ,p_text => c_proc || 'length of l_body2= '|| length(l_body2));
...
apps_util.utl.log_add(p_appl_id => 1, p_trans_id => null, p_message_type_id => 1 ,p_text => c_proc || 'length of body= '|| length(pi_body));
