...
--   Date and Time:   11:40 Friday August 11, 2023
...
,p_last_upd_yyyymmddhh24miss=>'20230725091437'
...
,p_list_item_current_for_pages=>'1,2,3,5,8,100,100,99,98,14,7,7'
);
wwv_flow_api.create_list_item(
...
,p_attribute_01=>'select 1 from dual where :APP_USER in  (''POONAM'')'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'POONAM'
,p_last_upd_yyyymmddhh24miss=>'20220517161843'
);
wwv_flow_api.create_page_plug(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'POONAM'
,p_last_upd_yyyymmddhh24miss=>'20210810111204'
);
wwv_flow_api.create_report_region(
...
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(80759908200398844)
,p_item_default=>'Nominations due Aug 31st, 2023.'
