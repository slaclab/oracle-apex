...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for View V_CONNINV_HISTORY
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "CAPTAR"."V_CONNINV_HISTORY" ("EVENT", "EVENT_DATE", "CONNINV_ID", "CREATED_BY", "CREATED_DATE", "MODIFIED_BY", "MODIFIED_DATE", "LOC", "RACK", "SIDE", "ELE", "SLOT", "CONNNUM", "PINLIST", "CABLENUM", "CONNTYPE", "STATION", "INSTR", "STATION_OLD") AS 
  select EVENT,
EVENT_DATE,
CONNINV_ID,
CREATED_BY,
