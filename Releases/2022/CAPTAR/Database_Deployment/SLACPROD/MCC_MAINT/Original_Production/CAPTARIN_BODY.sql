...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Package Body CAPTARIN
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "CAPTAR"."CAPTARIN" 
IS
-----------------------------------------------------------------------------
 ...
 */
	  ...
	  (mCablenum, mCable_Type, mJob, mUser_ID, SYSDATE, mCable_Function, mFormal_Device_Name, mLength, mRouting, mRevision, ListNo, mDRAWING,mDRAWING_TITLE);
          ...
          CODEPOINT := 56;
          INSERT INTO captar.conninv (loc, rack, side, ele, slot, connnum, pinlist, conntype, station, instr, cablenum)
          VALUES (morigin_Loc, morigin_Rack, morigin_Side, morigin_Ele, morigin_Slot, morigin_Conn, morigin_Pin_list, morigin_Conn_Type, morigin_Station, morigin_Ins, mCablenum);

          CODEPOINT := 57;
          INSERT INTO captar.conninv (loc, rack, side, ele, slot, connnum, pinlist, conntype, station, instr, cablenum)
          VALUES (mdest_Loc, mdest_Rack, mdest_Side, mdest_Ele, mdest_Slot, mdest_Conn, mdest_Pin_list, mdest_Conn_type, mdest_Station, mdest_Ins, mCablenum);
       END IF;
