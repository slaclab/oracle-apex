...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Trigger MAGNET_STRING_BIUDR
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "LCLS_INFRASTRUCTURE"."MAGNET_STRING_BIUDR" 
...
/
ALTER TRIGGER "LCLS_INFRASTRUCTURE"."MAGNET_STRING_BIUDR" ENABLE;
