create or replace view MAGNET_STRING_HISTORY_VW (
ROWNUM_OLD,
ROWNUM_NEW,
PSC_ID,
BARCODE,
...
OLD_DEGAUSS_SETL,
NEW_DEGAUSS_SETL,
OLD_DEGAUSS_RAMP_RATE,
NEW_DEGAUSS_RAMP_RATE,
OLD_DEGAUSS_WF_UOM,
NEW_DEGAUSS_WF_UOM,
OLD_DEGAUSS_RAMP_RATE_UOM,
NEW_DEGAUSS_RAMP_RATE_UOM,
OLD_DEGAUSS_SETL_UOM,
NEW_DEGAUSS_SETL_UOM,
OLD_DEGAUSS_STEP_SIZE,
NEW_DEGAUSS_STEP_SIZE,
OLD_DEGAUSS_STEP_SIZE_UOM,
NEW_DEGAUSS_STEP_SIZE_UOM,
OLD_DEGAUSS_WF_ELEM_CNT,
NEW_DEGAUSS_WF_ELEM_CNT,
OLD_DEGAUSS_WF,
NEW_DEGAUSS_WF,
CREATED_BY,
DATE_CREATED,
