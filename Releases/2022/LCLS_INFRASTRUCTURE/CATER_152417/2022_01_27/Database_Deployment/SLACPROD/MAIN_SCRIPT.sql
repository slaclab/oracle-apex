...
@MAGNET_POLYNOMIALS_CHANGES_VW.sql
@V_LINACZ_ENGG_NAME_CHANGE.sql
@COMPARE_MAGNET_POLY_CHANGES.sql
@COMPARE_SYMBOLS_COLS_CHANGE.sql
@COMPARE_POLY_COEFF_CHANGES_JOB.sql
@COMPARE_SYMBOLS_CHANGES_JOB.sql
spool off;
